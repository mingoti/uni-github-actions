...
Your new action will run any time a pull request has been opened. Yes, let's continue.
=======
...
<!--
  <<< Author notes: Footer >>>
  Add a link to get support, GitHub status page, code of conduct, license link. Cool!
-->
